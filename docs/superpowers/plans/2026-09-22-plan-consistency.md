# Уточнения к планам 1–4 (история сверки)

> Статус: **все пункты внесены** в спеку, манифест и планы 1–4 (коммиты `7860cc7`, `9c6938f`, `8cd70be`, `db11cd0` и правка плана 4). Документ сохранён как обоснование решений; исполнителю достаточно самих планов.

Это результат сверки планов 22 сентября 2026. Код в планах — проектные наброски, он ещё не собран и не протестирован. Финансовые переходы и завершённые правила жизненного цикла перенесены в спецификацию и манифест; новые функции сверх согласованного объёма не добавляются.
...
- [x] План 1 task 2, 6–8: ownership резервов/claims, ChangeStamp, арифметика Post.
- [x] План 2 (переписан целиком): снимки own holds/claims, группировка строк, fingerprint и корректный Warning.
- [x] План 3 (переписан целиком: runner, receipts, атомарные команды, задачи 8–9 — регрессионная матрица): схемы claims/receipts, атомарные операции, permissions, все regression-тесты.
- [x] План 4: operation scopes (из плана 3), CurrentActor, UI, provider adapters, окончательная проверка демо.
