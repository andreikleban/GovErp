...
/// <summary>
/// Collection of rule versions.
/// </summary>
public interface IRuleDefinitionRepository
{
    /// <summary>
    /// Returns all versions and layers, including disabled definitions, for domain resolution.
    /// </summary>
    Task<IReadOnlyList<RuleDefinition>> ListAsync(CancellationToken ct = default);

    /// <summary>
    /// A new rule version. Existing versions never change: past evaluations refer to them.
    /// </summary>
