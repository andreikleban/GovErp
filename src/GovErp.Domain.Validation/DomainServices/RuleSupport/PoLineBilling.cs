...
/// <summary>
/// How the invoice bills one PO line: what it liquidates, what needs new budget, how far cumulative billing goes past the PO.
/// </summary>
    ...
    string? Error)
{
    ...
    /// <summary>
    /// Already posted + other open invoices + this invoice.
    /// </summary>
