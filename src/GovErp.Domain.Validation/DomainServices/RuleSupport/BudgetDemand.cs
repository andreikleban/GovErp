...
/// <summary>
/// What the invoice asks from one budget line (account and fiscal year), summed over its invoice lines.
/// </summary>
    ...
    string? Error)
{
    ...
    /// <summary>
    /// Available after the invoice: available + the invoice's own reservation − the new budget it requires.
    /// </summary>
    ...
    /// <summary>
    /// AvailableAfter as a share of the amended budget; 1 when there is no amended budget to compare with.
    /// </summary>
