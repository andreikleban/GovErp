...
/// <summary>
/// Reads the tenant catalog from the master database.
/// </summary>
public sealed class MasterTenantCatalog(MasterDbContext master, IOptions<TenancyOptions> options) : ITenantCatalog
{
    ...
    /// <summary>
    /// The secret is read from configuration by the tenant's CredentialKey and does not leave Infrastructure.
    /// </summary>
