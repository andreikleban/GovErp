...
/// <summary>
/// Builds a rule card from its definition and the catalog.
/// </summary>
internal static class RuleVmMapping
{
    /// <summary>
    /// Versions that apply on the date: the general set plus scoped versions within their fund and grant.
    /// </summary>
